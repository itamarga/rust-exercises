...
pub fn find_nearest_intersection() -> i32 {
    ...
    let closest_intersection = a_points_set
        ...
        .unwrap();
    return closest_intersection.x.abs() + closest_intersection.y.abs();
}
...
pub fn find_shortest_path_to_intersection() -> u32 {
    ...
    let closest_intersection = a_points_set
        ...
        .unwrap();
    return combined_distance(closest_intersection, &a_points, &b_points);
}
